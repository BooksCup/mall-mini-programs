    ...
    <div class="order_ii" ref="cart">
        ...
        <div style="position: relative;">
            ...
            <view class="skeleton">
                ...
                <!--  有商品时显示   -->
                <ul class="goods" v-if="goodsList.length && load">
                    <!-- 店铺名称 -->
                    <div :key="shopIndex" v-for="(shopItem, shopIndex) in shopList">
                        <!-- 店铺之间分割线 -->
                        <div class="hr" v-if="shopIndex > 0"></div>
                        <div :key="'a' + shopItem.shopIndex" class="shop-name">
                            <image :src="shopSelectFlagList[shopIndex] ? icon_selected_true : icon_selected_false" @tap="_selectAllStore(item1, index1)"
                                class="img1"></image>
                            <image :src="icon_store" class="img2"></image>

                            <p @tap="toStore(shopItem.id)">{{ shopItem.name }}</p>
                            <span @tap="toStore(shopItem.id)">
                        ...
                        <template v-for="(item, index) in goods">
                            <li :key="index" v-if="item1.id === item.mch_id">
                                ...
                                <div class="store_img"><img :src="item.imgurl" @tap="_goodsDetailed(item.pid)" class="goods_img" /></div>
                                ...
                                <div class="goods_right">
                                    ...
                                    <div class="goods_bottom">
                                        ...
                                        <div class="goods_mun">
                                            ...
                                            <span :class="[item.num == 1 ? 'mun1' : '']" class="mun">{{ item.num }}</span>
                ...
                <!--  没有商品时显示   -->
                <div class="empty skeleton-rect" v-if="!this.goodsList.length">
                    <img :src="kong" />
                    <p>购物车是空的</p>
                ...
                <ul class="allgoods" v-if="load">
                    <li :key="index" @tap="_goods(items.id)" class="allgoods_li" v-for="(items, index) in list" v-if="load">
                        <div class="proImgBox">
                        ...
                        <div class="mask_over">
                            <scroll-view scroll-y style="height: 100%;">
                                ...
                                <div class="mask_num">
                                    <p>数量</p>
                                    <div class="goods_mun">
                                        <span class="border-right"><img :src="numb == 1 ? jian_hui : jian_hei" @tap="changeStock(1)" /></span>
                                        <span class="mun">{{ numb }}</span>
                                        <span class="border-left"><img :src="numb > num ? jia_hei : jia_hui" @tap="changeStock(2)" /></span>
                                    </div>
                                </div>
                            </scroll-view>
                        </div>
    ...
    export default {
        data() {
            return {
                ...
                // 单选框(选中)
                icon_selected_true: this.$common.ROOT_URL + '/static/images/icon/icon_selected_true.png',
                // 单选框(未选中)
                icon_selected_false: this.$common.ROOT_URL + '/static/images/icon/icon_selected_false.png',
        ...
        methods: {
            ...
            */
            ...
            getCartGoods() {
                ...
                this.$index.getCartProfile(data).then(res => {
                    if (!this.load) {
                        uni.hideLoading()
                    }
                    ...
                    this.isLogin(() => {
                        ...
                        this.$req.post({
                            ...
                            if (res.code == 200) {
                                ...
                                uni.navigateTo({
                                    url: '/pages/pay/orderDetailsr?cart_id=' + cart_id +
                                        '&canshu=true&returnR=1'
                                })
                            } else {
                                uni.showToast({
                                    title: '库存不足!',
                    ...
                    for (var j = 0; j < this.goods.length; j++) {
                        ...
                        if (storeId == this.goods[j].mch_id) {
                            if (cum >= 0) {
                                ...
                                let cum2 = this.selectStoreArray[index].findIndex((selectItem) => selectItem.id ===
                                    this.goods[j].id)
            ...
            countCartGoodsNum() {
                ...
                //添加，移除tabbar购物车小点提醒
                if (this.cartNum) {
                    var cartNumStr = String(this.cartNum)
