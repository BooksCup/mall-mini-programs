    ...
    <div>
        ...
        <div v-if='pass' style='position: relative;'>
            <div class='login'>
                <div class='login_inpu loginsss'>
                    <input placeholder-style="color:#b8b8b8" type="text" placeholder="请输入账号" :disabled="phoneS"
                ...
                <div class='login_inpu loginsss' v-show='code_dis'>
                    <input type="number" placeholder-style="color:#b8b8b8" placeholder="验证码" v-model="phone_code"
                           @input="_changeStep1"/>
        ...
        <div v-if='!pass'>
            <div class='login' style='position: relative;'>
                <div class='login_inpu loginsss'>
                    <input v-if='!pwFlag' type="password" placeholder="请输入6-15位数字或字母密码!"
                           placeholder-style="color:#b8b8b8" v-model="new_password" @focus="_phone_t(2)"
                           @blur="_w_password(1)" @input="_changeStep2"/>
                    <input v-else type="text" placeholder="请输入6-15位数字或字母密码!" placeholder-style="color:#b8b8b8"
                ...
                <div class='login_inpu loginsss'>
                    <input v-if='!pwFlag1' type="password" placeholder="确认新密码" placeholder-style="color:#b8b8b8"
                           v-model="old_password" @focus="_phone_t(3)" @blur="_w_password(2)" @input="_changeStep2"/>
                    <input v-else type="text" placeholder="确认新密码" placeholder-style="color:#b8b8b8"
                           v-model="old_password" @focus="_phone_t(3)" @blur="_w_password(2)" @input="_changeStep2"/>
